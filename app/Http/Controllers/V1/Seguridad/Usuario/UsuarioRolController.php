...
class UsuarioRolController extends ApiController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->rols_id as $value) {
    ...
    {
        $validar = [
            'rols_id.*.id' => 'required|integer|exists:rols,id',
    ...
    {
        return [
            'rols_id.*.id.required' => 'El rol es obligatorio',
            'rols_id.*.id.integer' => 'El rol no es un número',
            'rols_id.*.id.exists' => 'El rol no existe en la base de datos',
